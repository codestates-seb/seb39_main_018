...
public class KOAuthControllerTest {
    ...
    public void setUri() {
        ...
        kakaoClientId = env.getProperty("spring.social.kakao.client-id");
        kakaoRedirectUri = env.getProperty("spring.social.kakao.redirect");
    }

    @Test
    public void REST_API_KEY_카카오로그인_요청() {
        String loginUri = env.getProperty("spring.social.kakao.url.login");
