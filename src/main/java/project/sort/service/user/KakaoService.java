...
import project.sort.dto.social.RetKakaoOAuth;
...
public class KakaoService {
    ...
    public KakaoProfile getKakaoProfile(String kakaoAccessToken) {
        ...
        String requestUrl = env.getProperty("spring.social.kakao.url.profile");
    ...
    public RetKakaoOAuth getKakaoTokenInfo(String code) {
        ...
        String requestUri = env.getProperty("spring.social.kakao.url.token");
    ...
    public void kakaoUnlink(String accessToken) {
        String unlinkUrl = env.getProperty("spring.social.kakao.url.unlink");
